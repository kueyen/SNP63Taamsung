<template>
  <div class="p-5">
    <card>
      ...
      <hr />
      <div class="row">
        <div class="col-md-2 d-flex mt-3" v-for="(item, index) in items.data" :key="item.id">
          <div class="card h-100 w-100">
            ...
            <div class="card-footer">
              <button class="btn btn-primary" @click="update(item.id, 2, item.amount)">
                เสิร์ฟ
              </button>
              <button class="btn btn-warning" @click="update(item.id, 3, item.amount_v)">
                ยกเลิก
              </button>
            </div>
          </div>
